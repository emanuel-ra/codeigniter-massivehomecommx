    ...
    <div class="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
        ...
        <div class="lg:flex lg:items-end lg:justify-between">
            ...
            <ul
                ...
                <li>
                    <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Inicio </a>
                </li>

                <li>
                    <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Productos </a>
                </li>
                ...
                <li>
                    <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Devoluciones </a>
                </li>
            </ul>
        </div>
