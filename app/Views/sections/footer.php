        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
                ...
                <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                    <li>
                        <a
                            href="https://www.facebook.com/massivehome.com.mx"
                            rel="noreferrer"
                            target="_blank"
                    ...
                    <li>
                        <a
                            href="https://www.instagram.com/massivehome.com.mx/"
                            rel="noreferrer"
                            target="_blank"
                            class="text-teal-700 transition hover:text-teal-700/75">
                    ...
                    <li>
                        <a
                            href="https://www.tiktok.com/@massivehome.com.mx"
                            rel="noreferrer"
                            target="_blank"
                            class="text-teal-700 transition hover:text-teal-700/75">
                    ...
                    <li>
                        <a
                            href="https://www.linkedin.com/company/massivehomemx/posts/?feedView=all"
                            rel="noreferrer"
                            target="_blank"
                            class="text-teal-700 transition hover:text-teal-700/75">
                    ...
                    <li>
                        <a
                            href="https://linktr.ee/massivehome.com.mx?fbclid=IwY2xjawIcRKNleHRuA2FlbQIxMAABHRvvPGLclT_prXbTGyxvEU1_Xvbhzf_-g6fRWaLZbSo4knRfOn8eV9qgXQ_aem_y7xYu-nLEkhdXMHz6lISEw"
                            rel="noreferrer"
                            target="_blank"
                            class="text-teal-700 transition hover:text-teal-700/75">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                ...
                <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-gray-900">Contacto</p>
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a
                                ...
                                <span class="flex-1 text-gray-700">ventas@massivehome.com.mx</span>
                            </a>
                        </li>
...
2                                13 Lane, London, United Kingdom
                            </address>
                        </li> -->
                    </ul>
                </div>
