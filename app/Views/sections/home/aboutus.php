<section>
    <!-- Container -->
    <div class="mx-auto w-full max-w-7xl px-5 py-10 md:px-6 md:py-12">
        <!-- Component -->
        <div class="grid gap-12 sm:gap-12 md:grid-cols-2">
            ...
            <!-- Image -->
            <img src="<?= base_url() ?>/assets/images/MARIANO-OTERO.webp" alt="Sobre Nosotros" class="w-full h-auto rounded">
